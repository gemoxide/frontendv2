...
const Account = () => {
  ...
  const { loading: updateUserAvatarLoading, success: updateUserAvatarSuccess } =
  ...
  const formik = useFormik({
    initialValues: {
      ...
      first_name: data?.attributes?.name || data?.attributes?.first_name || "",
      last_name: data?.attributes?.name || data?.attributes?.last_name || "",
